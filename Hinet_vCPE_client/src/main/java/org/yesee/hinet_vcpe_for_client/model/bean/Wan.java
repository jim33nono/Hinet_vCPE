...
public class Wan implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7310755809580350273L;
	...
	public String toString() {
		return "Wan [id=" + id + ", wanName=" + wanName + ", portId=" + portId + ", wanIp=" + wanIp + ", subnet="
				+ subnet + ", defaultGateway=" + defaultGateway + ", defaultSetting=" + defaultSetting + ", userId="
				+ userId + ", updateDate=" + updateDate + "]";
	}
