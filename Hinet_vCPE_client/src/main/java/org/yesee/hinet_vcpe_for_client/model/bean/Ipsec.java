...
public class Ipsec implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 800267504642425009L;
	...
	public String toString() {
		return "Ipsec [id=" + id + ", ipsecName=" + ipsecName + ", remoteLanIp=" + remoteLanIp + ", remoteLanSubnet="
				+ remoteLanSubnet + ", remoteWanIp=" + remoteWanIp + ", wanId=" + wanId + ", siteToSiteIp="
				+ siteToSiteIp + ", preSharedKey=" + preSharedKey + ", gatewayInterface=" + gatewayInterface
